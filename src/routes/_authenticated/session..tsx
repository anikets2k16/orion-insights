...
function SessionPage() {
  ...
  // Resume any in-flight sessions and poll local state for updates.
  useEffect(() => {
    resumeInFlight();
  ...
  // If we don't have local state (e.g. opened from History on another device),
  // try to load a saved report from Supabase.
  useEffect(() => {
  ...
  // Mirror the final report and counts to Supabase exactly once.
  useEffect(() => {
